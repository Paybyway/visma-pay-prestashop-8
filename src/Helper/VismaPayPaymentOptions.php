...
class VismaPayPaymentOptions
{
        ...
        foreach ($merchantPaymentMethods as $paymentMethod) {
            ...
            switch ($type) {
                ...
                case 'banks':
                    ...
                    break;
                case 'creditinvoices':
                    if ((bool) \Configuration::get('VP_SELECT_CINVOICES')) {
    ...
    private function getVismaPayPaymentOption(): ?array
    {
        ...
        $paymentOption = new PaymentOption();
        $paymentOption->setCallToActionText($this->module->getTranslator()->trans('Visma Pay - internet banking, credit cards, credit invoices and wallet services', [], 'Modules.Vismapay.VismaPayPaymentOptions'))
